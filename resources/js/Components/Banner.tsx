    ...
    return (
        <div>
            {show && message ? (
                ...
                >
                    <div className="mx-auto max-w-screen-xl px-3 py-2 lg:px-8 sm:px-6">
                        <div className="flex flex-wrap items-center justify-between">
                            ...
                            <div className="flex-shrink-0 sm:ml-3">
                                <button
                                    type="button"
                                    className={classNames(
                                        "-mr-1 sm:-mr-2 flex rounded-md p-2 transition focus:outline-none",
                                        {
                                            "focus:bg-indigo-600 hover:bg-indigo-600":
                                                style === "success",
                                            "focus:bg-red-600 hover:bg-red-600":
                                                style === "danger",
                                        },
                                    )}
                                    aria-label="Dismiss"
