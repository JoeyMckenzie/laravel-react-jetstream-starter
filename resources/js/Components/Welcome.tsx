...
export default function Welcome() {
    return (
        <div>
            <div className="border-gray-200 border-b bg-white p-6 dark:border-gray-700 dark:bg-gradient-to-bl dark:bg-gray-800 dark:from-gray-700/50 dark:via-transparent lg:p-8">
                <ApplicationLogo className="block h-12 w-auto" />

                <h1 className="mt-8 font-medium text-2xl text-gray-900 dark:text-white">
                    Welcome to your Jetstream application!
                </h1>

                <p className="mt-6 text-gray-500 leading-relaxed dark:text-gray-400">
            ...
            <div className="grid grid-cols-1 gap-6 bg-gray-200 bg-opacity-25 p-6 md:grid-cols-2 lg:gap-8 dark:bg-gray-800 lg:p-8">
                <div>
                    <div className="flex items-center">
                        ...
                        <h2 className="ml-3 font-semibold text-gray-900 text-xl dark:text-white">
                ...
                <div>
                    ...
                    <p className="mt-4 text-gray-500 text-sm leading-relaxed dark:text-gray-400">
                        ...
                        you're free to get started with what matters most:
