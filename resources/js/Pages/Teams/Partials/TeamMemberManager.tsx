...
export default function TeamMemberManager({
    ...
    const [managingRoleFor, setManagingRoleFor] =
    ...
    return (
        <div>
                ...
                <div>
                    ...
                    >
                        <div className="col-span-6">
                            <div className="max-w-xl text-gray-600 text-sm dark:text-gray-400">
                        ...
                        {availableRoles.length > 0 ? (
                            <div className="col-span-6 lg:col-span-4">
                                ...
                                <div className="relative z-0 mt-1 cursor-pointer rounded-lg border border-gray-200 dark:border-gray-700">
                                    {availableRoles.map((role, i) => (
                                        <button
                                            type="button"
                                            className={classNames(
                                                "relative inline-flex w-full rounded-lg px-4 py-3 focus:z-10 dark:focus:border-indigo-600 focus:border-indigo-500 focus:outline-none dark:focus:ring-indigo-600 focus:ring-2 focus:ring-indigo-500",
                                                {
                                                    "rounded-t-none border-gray-200 border-t dark:border-gray-700 focus:border-none":
                                                        i > 0,
                                                    "rounded-b-none":
                                                        i !==
                                                        Object.keys(
                                ...
                                >
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        {userPermissions.canRemoveTeamMembers ? (
                                            <button
                                                type="button"
                                                className="ml-6 cursor-pointer text-red-500 text-sm focus:outline-none"
                                                onClick={() =>
                                ...
                                >
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        availableRoles.length ? (
                                            <button
                                                type="button"
                                                className="ml-2 text-gray-400 text-sm underline"
            ...
            >
                <DialogModal.Content title={"Manage Role"} />
                {managingRoleFor ? (
                    <div>
                        <div className="relative z-0 mt-1 cursor-pointer rounded-lg border border-gray-200 dark:border-gray-700">
                            {availableRoles.map((role, i) => (
